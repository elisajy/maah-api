...
exports.removeProductsFromCategory = exports.deleteCategory = exports.updateCategory = exports.createCategory = exports.getCategoryDetailsById = exports.getAllCategories = void 0;
/**
 *
 * @param fastify
 * @returns {
...
const createCategory = async (fastify, data) => {
    ...
    try {
        const [rows] = await connection.query("SELECT name, value FROM categories");
        ...
        const [result] = await connection.execute("INSERT INTO categories (name,value,sequence) VALUES (?,?,?)", [data.name, data.value, data.sequence || null]);
        res = result?.insertId
            ? {
                code: 201,
